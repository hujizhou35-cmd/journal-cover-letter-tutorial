...
- **Original Research：**重要问题 → 知识缺口 → 设计优势 → 核心发现 → 可辩护意义 → 读者价值。
- **Review/Synthesis：**领域问题 → 证据基础 → 综合创新 → 新框架或洞见 → 证据边界 → 启示。

本版本还加入故事选择、说服力校准和有界状态循环。v1.0 作为采用统一 `1-5-1-1` 流程的 Legacy 版本继续提供。
